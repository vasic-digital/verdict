...
Carrier read by Claude Code (claude.ai/code). One of the four governance
carriers §11.4.157 requires to be maintained in lockstep; everything below
the next heading is byte-identical across all four.
